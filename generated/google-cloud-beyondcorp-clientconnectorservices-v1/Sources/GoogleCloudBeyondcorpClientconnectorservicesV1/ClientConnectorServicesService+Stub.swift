...
extension Clients {
  protocol ClientConnectorServicesServiceStub {
  ...
  class ClientConnectorServicesServiceTransport: ClientConnectorServicesServiceStub {
      ...
      -> GoogleCloudBeyondcorpClientconnectorservicesV1.ListClientConnectorServicesResponse
    {
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/clientConnectorServices"
      }()
      var query = [
    ...
    public func createClientConnectorService(
      ...
      query.append(
        contentsOf: try encoder.encode(
          request.clientConnectorServiceId, prefix: "clientConnectorServiceId"))
    ...
    public func updateClientConnectorService(
      ...
      let path = try { () throws -> Swift.String in
        guard let pathVariable0 = request.clientConnectorService.map({ $0.name }),
          !pathVariable0.isEmpty
        else {
          throw GoogleCloudGax.RequestError.binding(
            "'request.client_connector_service.name' is not set or is empty")
        }
        return "/v1/\(pathVariable0)"
      }()
      var query = [
