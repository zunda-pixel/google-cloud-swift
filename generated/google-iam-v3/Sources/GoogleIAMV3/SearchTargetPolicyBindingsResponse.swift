...
public struct SearchTargetPolicyBindingsResponse: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  ...
  Sendable
{
  ...
  /// Initialize a new instance of `SearchTargetPolicyBindingsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SearchTargetPolicyBindingsResponse().with { $0.policyBindings = ... }
  /// ```
