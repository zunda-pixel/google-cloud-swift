...
public struct SearchPrincipalAccessBoundaryPolicyBindingsRequest: Codable, Equatable, GoogleCloudWkt
    ._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `SearchPrincipalAccessBoundaryPolicyBindingsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SearchPrincipalAccessBoundaryPolicyBindingsRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.iam.v3.SearchPrincipalAccessBoundaryPolicyBindingsRequest"
  }
