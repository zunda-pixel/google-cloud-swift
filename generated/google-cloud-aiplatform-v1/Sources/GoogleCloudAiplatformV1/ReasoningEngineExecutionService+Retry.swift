...
// limitations under the License.
  ...
  extension Clients {
    final class ReasoningEngineExecutionServiceRetry: ReasoningEngineExecutionServiceStub {
      let inner: any ReasoningEngineExecutionServiceStub
      let options: GoogleCloudGax.ClientOptions

      public init(
        _ inner: any ReasoningEngineExecutionServiceStub, options: GoogleCloudGax.ClientOptions
      ) {
        self.inner = inner
      ...
      public func queryReasoningEngine(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: QueryReasoningEngineRequest, o: GoogleCloudGax.RequestOptions) async throws
      ...
      public func streamQueryReasoningEngine(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: StreamQueryReasoningEngineRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleApi.HttpBody
            in
      ...
      public func asyncQueryReasoningEngine(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: AsyncQueryReasoningEngineRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleLongrunning.Operation
            in
            return try await self.inner.asyncQueryReasoningEngine(request: r, options: o)
          })
      }
      ...
      public func cancelAsyncQueryReasoningEngine(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: CancelAsyncQueryReasoningEngineRequest, o: GoogleCloudGax.RequestOptions)
              async throws -> GoogleCloudAiplatformV1.CancelAsyncQueryReasoningEngineResponse
            in
            return try await self.inner.cancelAsyncQueryReasoningEngine(request: r, options: o)
          })
      }
