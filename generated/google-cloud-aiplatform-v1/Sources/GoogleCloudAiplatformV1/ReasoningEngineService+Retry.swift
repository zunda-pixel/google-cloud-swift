...
// limitations under the License.
  ...
  extension Clients {
    final class ReasoningEngineServiceRetry: ReasoningEngineServiceStub {
      let inner: any ReasoningEngineServiceStub
      let options: GoogleCloudGax.ClientOptions

      public init(_ inner: any ReasoningEngineServiceStub, options: GoogleCloudGax.ClientOptions) {
        self.inner = inner
