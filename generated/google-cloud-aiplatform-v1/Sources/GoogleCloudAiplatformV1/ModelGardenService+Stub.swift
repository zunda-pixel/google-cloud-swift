...
// limitations under the License.
  ...
  extension Clients {
    ...
    class ModelGardenServiceTransport: ModelGardenServiceStub {
      ...
      public func getPublisherModel(
        ...
        query.append(
          contentsOf: try encoder.encode(request.isHuggingFaceModel, prefix: "isHuggingFaceModel"))
        query.append(
          contentsOf: try encoder.encode(request.huggingFaceToken, prefix: "huggingFaceToken"))
        var req = try await self.inner.Request(path: path, query: query)
        req.httpMethod = "GET"
        req.setValue(Clients.clientHeader, forHTTPHeaderField: "X-Goog-Api-Client")
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.PublisherModel.self, from: data)
      }
      ...
      public func deploy(
        ...
        let path = try { () throws -> Swift.String in
          guard let pathVariable0 = request.destination as Swift.String?, !pathVariable0.isEmpty
          else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.destination' is not set or is empty")
          }
