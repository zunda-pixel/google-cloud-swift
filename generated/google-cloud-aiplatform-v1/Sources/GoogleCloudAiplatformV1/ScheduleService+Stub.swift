...
// limitations under the License.
  ...
  extension Clients {
    ...
    class ScheduleServiceTransport: ScheduleServiceStub {
      ...
      public func createSchedule(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0)/schedules"
        }()
        let query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.Schedule.self, from: data)
      }
      ...
      public func listSchedules(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.ListSchedulesResponse.self, from: data)
      }
      ...
      public func updateSchedule(
        ...
        let path = try { () throws -> Swift.String in
          guard let pathVariable0 = request.schedule.map({ $0.name }), !pathVariable0.isEmpty else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.schedule.name' is not set or is empty")
          }
          return "/v1/\(pathVariable0)"
        }()
        var query = [
