...
// limitations under the License.
  ...
  extension Clients {
    ...
    class PredictionServiceTransport: PredictionServiceStub {
      ...
      public func predict(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0):predict"
        }()
        let query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.PredictResponse.self, from: data)
      }
      ...
      public func rawPredict(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0):rawPredict"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
      ...
      public func streamRawPredict(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0):streamRawPredict"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
      ...
      public func directPredict(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0):directPredict"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.DirectPredictResponse.self, from: data)
      }
      ...
      public func directRawPredict(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0):directRawPredict"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.DirectRawPredictResponse.self, from: data)
      }
      ...
      public func serverStreamingPredict(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0):serverStreamingPredict"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.StreamingPredictResponse.self, from: data)
      }
      ...
      public func explain(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0):explain"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.ExplainResponse.self, from: data)
      }
      ...
      public func generateContent(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0):generateContent"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.GenerateContentResponse.self, from: data)
      }
      ...
      public func streamGenerateContent(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0):streamGenerateContent"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
      ...
      public func embedContent(
        ...
        let path = try { () throws -> Swift.String in
          guard let pathVariable0 = request.model, !pathVariable0.isEmpty else {
            throw GoogleCloudGax.RequestError.binding("'request.model' is not set or is empty")
          }
          return "/v1/\(pathVariable0):embedContent"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.EmbedContentResponse.self, from: data)
      }
