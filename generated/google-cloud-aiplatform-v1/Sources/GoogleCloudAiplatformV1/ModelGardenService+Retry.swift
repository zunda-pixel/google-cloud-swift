...
// limitations under the License.
  ...
  extension Clients {
    final class ModelGardenServiceRetry: ModelGardenServiceStub {
      let inner: any ModelGardenServiceStub
      let options: GoogleCloudGax.ClientOptions

      public init(_ inner: any ModelGardenServiceStub, options: GoogleCloudGax.ClientOptions) {
        self.inner = inner
      ...
      public func getPublisherModel(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: GetPublisherModelRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleCloudAiplatformV1.PublisherModel
            in
            return try await self.inner.getPublisherModel(request: r, options: o)
          })
      }
      ...
      public func deploy(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: DeployRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleLongrunning.Operation
            in
            return try await self.inner.deploy(request: r, options: o)
          })
      }
