    ...
    class MigrationServiceTransport: MigrationServiceStub {
      ...
      public func searchMigratableResources(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0)/migratableResources:search"
        }()
        let query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.SearchMigratableResourcesResponse.self, from: data)
      }
      ...
      public func batchMigrateResources(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0)/migratableResources:batchMigrate"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
