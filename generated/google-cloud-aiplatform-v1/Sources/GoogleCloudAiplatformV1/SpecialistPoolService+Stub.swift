...
// limitations under the License.
  ...
  extension Clients {
    protocol SpecialistPoolServiceStub {
    ...
    class SpecialistPoolServiceTransport: SpecialistPoolServiceStub {
      ...
      public func createSpecialistPool(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0)/specialistPools"
        }()
        let query = [
      ...
      public func getSpecialistPool(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.SpecialistPool.self, from: data)
      }
      ...
      public func listSpecialistPools(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.ListSpecialistPoolsResponse.self, from: data)
      }
      ...
      public func updateSpecialistPool(
        ...
        let path = try { () throws -> Swift.String in
          guard let pathVariable0 = request.specialistPool.map({ $0.name }), !pathVariable0.isEmpty
          else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.specialist_pool.name' is not set or is empty")
          }
          return "/v1/\(pathVariable0)"
        }()
        var query = [
