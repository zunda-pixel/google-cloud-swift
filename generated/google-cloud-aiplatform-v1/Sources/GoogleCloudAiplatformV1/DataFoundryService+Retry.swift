...
// limitations under the License.
  ...
  extension Clients {
    final class DataFoundryServiceRetry: DataFoundryServiceStub {
      let inner: any DataFoundryServiceStub
      let options: GoogleCloudGax.ClientOptions

      public init(_ inner: any DataFoundryServiceStub, options: GoogleCloudGax.ClientOptions) {
        self.inner = inner
      ...
      public func generateSyntheticData(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: GenerateSyntheticDataRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleCloudAiplatformV1.GenerateSyntheticDataResponse
            in
            return try await self.inner.generateSyntheticData(request: r, options: o)
          })
      }
