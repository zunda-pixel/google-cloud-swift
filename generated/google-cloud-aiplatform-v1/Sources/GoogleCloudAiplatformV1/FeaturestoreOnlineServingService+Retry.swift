...
// limitations under the License.
  ...
  extension Clients {
    final class FeaturestoreOnlineServingServiceRetry: FeaturestoreOnlineServingServiceStub {
      let inner: any FeaturestoreOnlineServingServiceStub
      let options: GoogleCloudGax.ClientOptions

      public init(
        _ inner: any FeaturestoreOnlineServingServiceStub, options: GoogleCloudGax.ClientOptions
      ) {
        self.inner = inner
      ...
      public func readFeatureValues(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: ReadFeatureValuesRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleCloudAiplatformV1.ReadFeatureValuesResponse
            in
            return try await self.inner.readFeatureValues(request: r, options: o)
          })
      }
      ...
      public func streamingReadFeatureValues(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: StreamingReadFeatureValuesRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleCloudAiplatformV1.ReadFeatureValuesResponse
            in
      ...
      public func writeFeatureValues(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: WriteFeatureValuesRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleCloudAiplatformV1.WriteFeatureValuesResponse
            in
            return try await self.inner.writeFeatureValues(request: r, options: o)
          })
      }
