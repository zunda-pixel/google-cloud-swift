...
// limitations under the License.
  ...
  extension Clients {
    protocol DataFoundryServiceStub {
    ...
    class DataFoundryServiceTransport: DataFoundryServiceStub {
      ...
      public func generateSyntheticData(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0):generateSyntheticData"
        }()
        let query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.GenerateSyntheticDataResponse.self, from: data)
      }
