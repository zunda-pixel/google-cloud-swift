...
// limitations under the License.
  ...
  extension Clients {
    final class ReasoningEngineExecutionServiceLogging: ReasoningEngineExecutionServiceStub {
      ...
      public func asyncQueryReasoningEngine(
        ...
        try await self._intercept(
          request: request,
          options: options,
          name: "asyncQueryReasoningEngine",
          action: {
      ...
      public func cancelAsyncQueryReasoningEngine(
        ...
        try await self._intercept(
          request: request,
          options: options,
          name: "cancelAsyncQueryReasoningEngine",
          action: {
