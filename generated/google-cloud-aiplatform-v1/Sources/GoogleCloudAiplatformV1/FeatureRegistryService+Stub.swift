...
// limitations under the License.
  ...
  extension Clients {
    ...
    class FeatureRegistryServiceTransport: FeatureRegistryServiceStub {
      ...
      public func createFeatureGroup(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0)/featureGroups"
        }()
        var query = [
        ...
        query.append(
          contentsOf: try encoder.encode(request.featureGroupId, prefix: "featureGroupId"))
      ...
      public func getFeatureGroup(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.FeatureGroup.self, from: data)
      }
      ...
      public func listFeatureGroups(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.ListFeatureGroupsResponse.self, from: data)
      }
      ...
      public func updateFeatureGroup(
        ...
        let path = try { () throws -> Swift.String in
          guard let pathVariable0 = request.featureGroup.map({ $0.name }), !pathVariable0.isEmpty
          else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.feature_group.name' is not set or is empty")
          }
          return "/v1/\(pathVariable0)"
        }()
        var query = [
