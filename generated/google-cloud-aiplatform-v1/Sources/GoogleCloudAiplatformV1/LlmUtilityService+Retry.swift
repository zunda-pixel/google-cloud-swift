...
// limitations under the License.
  ...
  extension Clients {
    final class LlmUtilityServiceRetry: LlmUtilityServiceStub {
      let inner: any LlmUtilityServiceStub
      let options: GoogleCloudGax.ClientOptions

      public init(_ inner: any LlmUtilityServiceStub, options: GoogleCloudGax.ClientOptions) {
        self.inner = inner
      ...
      public func countTokens(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: CountTokensRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleCloudAiplatformV1.CountTokensResponse
            in
            return try await self.inner.countTokens(request: r, options: o)
          })
      }
      ...
      public func computeTokens(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: ComputeTokensRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleCloudAiplatformV1.ComputeTokensResponse
            in
            return try await self.inner.computeTokens(request: r, options: o)
          })
      }
