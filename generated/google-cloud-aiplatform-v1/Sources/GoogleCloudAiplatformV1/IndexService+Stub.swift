...
// limitations under the License.
  ...
  extension Clients {
    ...
    class IndexServiceTransport: IndexServiceStub {
      ...
      public func getIndex(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.Index.self, from: data)
      }
      ...
      public func listIndexes(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.ListIndexesResponse.self, from: data)
      }
      ...
      public func upsertDatapoints(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0):upsertDatapoints"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.UpsertDatapointsResponse.self, from: data)
      }
      ...
      public func removeDatapoints(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0):removeDatapoints"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.RemoveDatapointsResponse.self, from: data)
      }
