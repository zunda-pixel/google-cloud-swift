...
// limitations under the License.
  ...
  extension Clients {
    ...
    class ReasoningEngineServiceTransport: ReasoningEngineServiceStub {
      ...
      public func createReasoningEngine(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0)/reasoningEngines"
        }()
        let query = [
        ...
        if let body = request.reasoningEngine {
      ...
      public func getReasoningEngine(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.ReasoningEngine.self, from: data)
      }
      ...
      public func listReasoningEngines(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.ListReasoningEnginesResponse.self, from: data)
      }
      ...
      public func updateReasoningEngine(
        ...
        let path = try { () throws -> Swift.String in
          guard let pathVariable0 = request.reasoningEngine.map({ $0.name }), !pathVariable0.isEmpty
          else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.reasoning_engine.name' is not set or is empty")
          }
          return "/v1/\(pathVariable0)"
        }()
        var query = [
