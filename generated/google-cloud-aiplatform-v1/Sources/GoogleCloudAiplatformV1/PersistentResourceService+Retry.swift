...
// limitations under the License.
  ...
  extension Clients {
    final class PersistentResourceServiceRetry: PersistentResourceServiceStub {
      let inner: any PersistentResourceServiceStub
      let options: GoogleCloudGax.ClientOptions

      public init(_ inner: any PersistentResourceServiceStub, options: GoogleCloudGax.ClientOptions)
      {
        self.inner = inner
      ...
      public func createPersistentResource(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: CreatePersistentResourceRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleLongrunning.Operation
            in
            return try await self.inner.createPersistentResource(request: r, options: o)
          })
      }
      ...
      public func getPersistentResource(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: GetPersistentResourceRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleCloudAiplatformV1.PersistentResource
            in
            return try await self.inner.getPersistentResource(request: r, options: o)
          })
      }
      ...
      public func listPersistentResources(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: ListPersistentResourcesRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleCloudAiplatformV1.ListPersistentResourcesResponse
            in
            return try await self.inner.listPersistentResources(request: r, options: o)
          })
      }
      ...
      public func deletePersistentResource(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: DeletePersistentResourceRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleLongrunning.Operation
            in
            return try await self.inner.deletePersistentResource(request: r, options: o)
          })
      }
      ...
      public func updatePersistentResource(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: UpdatePersistentResourceRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleLongrunning.Operation
            in
            return try await self.inner.updatePersistentResource(request: r, options: o)
          })
      }
      ...
      public func rebootPersistentResource(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: RebootPersistentResourceRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleLongrunning.Operation
            in
            return try await self.inner.rebootPersistentResource(request: r, options: o)
          })
      }
