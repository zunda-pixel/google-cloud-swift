...
// limitations under the License.
  ...
  extension Clients {
    final class IndexEndpointServiceRetry: IndexEndpointServiceStub {
      let inner: any IndexEndpointServiceStub
      let options: GoogleCloudGax.ClientOptions

      public init(_ inner: any IndexEndpointServiceStub, options: GoogleCloudGax.ClientOptions) {
        self.inner = inner
      ...
      public func mutateDeployedIndex(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: MutateDeployedIndexRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleLongrunning.Operation
            in
            return try await self.inner.mutateDeployedIndex(request: r, options: o)
          })
      }
