...
// limitations under the License.
  ...
  extension Clients {
    ...
    class GenAiTuningServiceTransport: GenAiTuningServiceStub {
      ...
      public func createTuningJob(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0)/tuningJobs"
        }()
        let query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.TuningJob.self, from: data)
      }
      ...
      public func listTuningJobs(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.ListTuningJobsResponse.self, from: data)
      }
      ...
      public func rebaseTunedModel(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0)/tuningJobs:rebaseTunedModel"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
