...
// limitations under the License.
  ...
  extension Clients {
    ...
    class MatchServiceTransport: MatchServiceStub {
      ...
      public func findNeighbors(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0):findNeighbors"
        }()
        let query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.FindNeighborsResponse.self, from: data)
      }
      ...
      public func readIndexDatapoints(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0):readIndexDatapoints"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.ReadIndexDatapointsResponse.self, from: data)
      }
