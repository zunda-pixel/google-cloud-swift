...
// limitations under the License.
  ...
  extension Clients {
    ...
    class FeatureOnlineStoreAdminServiceTransport: FeatureOnlineStoreAdminServiceStub {
      ...
      public func createFeatureOnlineStore(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0)/featureOnlineStores"
        }()
        var query = [
        ...
        query.append(
          contentsOf: try encoder.encode(
            request.featureOnlineStoreId, prefix: "featureOnlineStoreId"))
      ...
      public func getFeatureOnlineStore(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.FeatureOnlineStore.self, from: data)
      }
      ...
      public func listFeatureOnlineStores(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.ListFeatureOnlineStoresResponse.self, from: data)
      }
      ...
      public func updateFeatureOnlineStore(
        ...
        let path = try { () throws -> Swift.String in
          guard let pathVariable0 = request.featureOnlineStore.map({ $0.name }),
            !pathVariable0.isEmpty
          else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.feature_online_store.name' is not set or is empty")
          }
          return "/v1/\(pathVariable0)"
        }()
        var query = [
      ...
      public func createFeatureView(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0)/featureViews"
        }()
        var query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
        let encoder = GoogleCloudGax.QueryParameterEncoder()
        query.append(contentsOf: try encoder.encode(request.featureViewId, prefix: "featureViewId"))
        query.append(
          contentsOf: try encoder.encode(request.runSyncImmediately, prefix: "runSyncImmediately"))
        var req = try await self.inner.Request(path: path, query: query)
        req.httpMethod = "POST"
        req.setValue(Clients.clientHeader, forHTTPHeaderField: "X-Goog-Api-Client")
      ...
      public func getFeatureView(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.FeatureView.self, from: data)
      }
      ...
      public func listFeatureViews(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.ListFeatureViewsResponse.self, from: data)
      }
      ...
      public func updateFeatureView(
        ...
        let path = try { () throws -> Swift.String in
          guard let pathVariable0 = request.featureView.map({ $0.name }), !pathVariable0.isEmpty
          else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.feature_view.name' is not set or is empty")
          }
          return "/v1/\(pathVariable0)"
        }()
        var query = [
      ...
      public func syncFeatureView(
        ...
        let path = try { () throws -> Swift.String in
          guard let pathVariable0 = request.featureView as Swift.String?, !pathVariable0.isEmpty
          else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.feature_view' is not set or is empty")
          }
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.SyncFeatureViewResponse.self, from: data)
      }
      ...
      public func getFeatureViewSync(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.FeatureViewSync.self, from: data)
      }
      ...
      public func listFeatureViewSyncs(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0)/featureViewSyncs"
        }()
        var query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.ListFeatureViewSyncsResponse.self, from: data)
      }
