...
// limitations under the License.
  ...
  extension Clients {
    final class FeatureOnlineStoreServiceRetry: FeatureOnlineStoreServiceStub {
      let inner: any FeatureOnlineStoreServiceStub
      let options: GoogleCloudGax.ClientOptions

      public init(_ inner: any FeatureOnlineStoreServiceStub, options: GoogleCloudGax.ClientOptions)
      {
        self.inner = inner
