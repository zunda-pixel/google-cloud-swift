    ...
    class PipelineServiceTransport: PipelineServiceStub {
      ...
      public func createTrainingPipeline(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0)/trainingPipelines"
        }()
        let query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.TrainingPipeline.self, from: data)
      }
      ...
      public func listTrainingPipelines(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.ListTrainingPipelinesResponse.self, from: data)
      }
      ...
      public func createPipelineJob(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0)/pipelineJobs"
        }()
        var query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
        let encoder = GoogleCloudGax.QueryParameterEncoder()
        query.append(contentsOf: try encoder.encode(request.pipelineJobId, prefix: "pipelineJobId"))
        var req = try await self.inner.Request(path: path, query: query)
        req.httpMethod = "POST"
        req.setValue(Clients.clientHeader, forHTTPHeaderField: "X-Goog-Api-Client")
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.PipelineJob.self, from: data)
      }
      ...
      public func listPipelineJobs(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.ListPipelineJobsResponse.self, from: data)
      }
      ...
      public func batchDeletePipelineJobs(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0)/pipelineJobs:batchDelete"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
      ...
      public func batchCancelPipelineJobs(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0)/pipelineJobs:batchCancel"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
