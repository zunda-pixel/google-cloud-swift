...
// limitations under the License.
  ...
  extension Clients {
    final class MatchServiceRetry: MatchServiceStub {
      let inner: any MatchServiceStub
      let options: GoogleCloudGax.ClientOptions

      public init(_ inner: any MatchServiceStub, options: GoogleCloudGax.ClientOptions) {
        self.inner = inner
      ...
      public func findNeighbors(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: FindNeighborsRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleCloudAiplatformV1.FindNeighborsResponse
            in
            return try await self.inner.findNeighbors(request: r, options: o)
          })
      }
      ...
      public func readIndexDatapoints(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: ReadIndexDatapointsRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleCloudAiplatformV1.ReadIndexDatapointsResponse
            in
            return try await self.inner.readIndexDatapoints(request: r, options: o)
          })
      }
