...
// limitations under the License.
  ...
  extension Clients {
    protocol LlmUtilityServiceStub {
      ...
      func computeTokens(
        request: ComputeTokensRequest, options: GoogleCloudGax.RequestOptions
    ...
    class LlmUtilityServiceTransport: LlmUtilityServiceStub {
      ...
      public func countTokens(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0):countTokens"
        }()
        let query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.CountTokensResponse.self, from: data)
      }
      ...
      public func computeTokens(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0):computeTokens"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.ComputeTokensResponse.self, from: data)
      }
