...
// limitations under the License.
  ...
  extension Clients {
    final class VertexRagServiceRetry: VertexRagServiceStub {
      let inner: any VertexRagServiceStub
      let options: GoogleCloudGax.ClientOptions

      public init(_ inner: any VertexRagServiceStub, options: GoogleCloudGax.ClientOptions) {
        self.inner = inner
      ...
      public func retrieveContexts(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: RetrieveContextsRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleCloudAiplatformV1.RetrieveContextsResponse
            in
            return try await self.inner.retrieveContexts(request: r, options: o)
          })
      }
      ...
      public func augmentPrompt(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: AugmentPromptRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleCloudAiplatformV1.AugmentPromptResponse
            in
            return try await self.inner.augmentPrompt(request: r, options: o)
          })
      }
      ...
      public func corroborateContent(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: CorroborateContentRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleCloudAiplatformV1.CorroborateContentResponse
            in
            return try await self.inner.corroborateContent(request: r, options: o)
          })
      }
      ...
      public func askContexts(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: AskContextsRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleCloudAiplatformV1.AskContextsResponse
            in
            return try await self.inner.askContexts(request: r, options: o)
          })
      }
      ...
      public func asyncRetrieveContexts(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: AsyncRetrieveContextsRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleLongrunning.Operation
            in
            return try await self.inner.asyncRetrieveContexts(request: r, options: o)
          })
      }
