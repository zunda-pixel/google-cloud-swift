    ...
    final class MigrationServiceLogging: MigrationServiceStub {
      ...
      public func searchMigratableResources(
        ...
        try await self._intercept(
          ...
          action: {
            (r: SearchMigratableResourcesRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleCloudAiplatformV1.SearchMigratableResourcesResponse
            in
            return try await self.inner.searchMigratableResources(request: r, options: o)
          })
      }
      ...
      public func batchMigrateResources(
        ...
        try await self._intercept(
          ...
          action: {
            (r: BatchMigrateResourcesRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleLongrunning.Operation
            in
            return try await self.inner.batchMigrateResources(request: r, options: o)
          })
      }
