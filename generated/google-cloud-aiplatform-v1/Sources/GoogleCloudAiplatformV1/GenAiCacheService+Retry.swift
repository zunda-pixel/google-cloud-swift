...
// limitations under the License.
  ...
  extension Clients {
    final class GenAiCacheServiceRetry: GenAiCacheServiceStub {
      let inner: any GenAiCacheServiceStub
      let options: GoogleCloudGax.ClientOptions

      public init(_ inner: any GenAiCacheServiceStub, options: GoogleCloudGax.ClientOptions) {
        self.inner = inner
      ...
      public func createCachedContent(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: CreateCachedContentRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleCloudAiplatformV1.CachedContent
            in
            return try await self.inner.createCachedContent(request: r, options: o)
          })
      }
      ...
      public func getCachedContent(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: GetCachedContentRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleCloudAiplatformV1.CachedContent
            in
            return try await self.inner.getCachedContent(request: r, options: o)
          })
      }
      ...
      public func updateCachedContent(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: UpdateCachedContentRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleCloudAiplatformV1.CachedContent
            in
            return try await self.inner.updateCachedContent(request: r, options: o)
          })
      }
      ...
      public func deleteCachedContent(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: DeleteCachedContentRequest, o: GoogleCloudGax.RequestOptions) async throws -> Void
            in
            return try await self.inner.deleteCachedContent(request: r, options: o)
          })
      }
      ...
      public func listCachedContents(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: ListCachedContentsRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleCloudAiplatformV1.ListCachedContentsResponse
            in
            return try await self.inner.listCachedContents(request: r, options: o)
          })
      }
