...
// limitations under the License.
  ...
  extension Clients {
    final class EvaluationServiceRetry: EvaluationServiceStub {
      let inner: any EvaluationServiceStub
      let options: GoogleCloudGax.ClientOptions

      public init(_ inner: any EvaluationServiceStub, options: GoogleCloudGax.ClientOptions) {
        self.inner = inner
      ...
      public func evaluateInstances(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: EvaluateInstancesRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleCloudAiplatformV1.EvaluateInstancesResponse
            in
            return try await self.inner.evaluateInstances(request: r, options: o)
          })
      }
