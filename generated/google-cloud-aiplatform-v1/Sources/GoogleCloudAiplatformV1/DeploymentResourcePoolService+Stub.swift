    ...
    class DeploymentResourcePoolServiceTransport: DeploymentResourcePoolServiceStub {
      ...
      public func createDeploymentResourcePool(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0)/deploymentResourcePools"
        }()
        let query = [
      ...
      public func getDeploymentResourcePool(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.DeploymentResourcePool.self, from: data)
      }
      ...
      public func listDeploymentResourcePools(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.ListDeploymentResourcePoolsResponse.self, from: data)
      }
      ...
      public func updateDeploymentResourcePool(
        ...
        let path = try { () throws -> Swift.String in
          guard let pathVariable0 = request.deploymentResourcePool.map({ $0.name }),
            !pathVariable0.isEmpty
          else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.deployment_resource_pool.name' is not set or is empty")
          }
          return "/v1/\(pathVariable0)"
        }()
        var query = [
      ...
      public func queryDeployedModels(
        ...
        let path = try { () throws -> Swift.String in
          guard let pathVariable0 = request.deploymentResourcePool as Swift.String?,
            !pathVariable0.isEmpty
          else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.deployment_resource_pool' is not set or is empty")
          }
          return "/v1/\(pathVariable0):queryDeployedModels"
        }()
        var query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.QueryDeployedModelsResponse.self, from: data)
      }
