  ...
  extension Clients {
    ...
    class SessionServiceTransport: SessionServiceStub {
      ...
      public func createSession(
        ...
        query.append(contentsOf: try encoder.encode(request.sessionId, prefix: "sessionId"))
      ...
      public func getSession(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.Session.self, from: data)
      }
      ...
      public func listSessions(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.ListSessionsResponse.self, from: data)
      }
      ...
      public func listEvents(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.ListEventsResponse.self, from: data)
      }
      ...
      public func appendEvent(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0):appendEvent"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.AppendEventResponse.self, from: data)
      }
