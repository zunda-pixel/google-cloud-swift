    ...
    class ReasoningEngineExecutionServiceTransport: ReasoningEngineExecutionServiceStub {
      ...
      public func queryReasoningEngine(
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.QueryReasoningEngineResponse.self, from: data)
      }
      ...
      public func streamQueryReasoningEngine(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0):streamQuery"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
      ...
      public func asyncQueryReasoningEngine(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0):asyncQuery"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
      ...
      public func cancelAsyncQueryReasoningEngine(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0):cancelAsyncQuery"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.CancelAsyncQueryReasoningEngineResponse.self, from: data)
      }
