...
// limitations under the License.
  ...
  extension Clients {
    ...
    class GenAiCacheServiceTransport: GenAiCacheServiceStub {
      ...
      public func createCachedContent(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0)/cachedContents"
        }()
        let query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.CachedContent.self, from: data)
      }
      ...
      public func updateCachedContent(
        ...
        let path = try { () throws -> Swift.String in
          guard let pathVariable0 = request.cachedContent.map({ $0.name }), !pathVariable0.isEmpty
          else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.cached_content.name' is not set or is empty")
          }
          return "/v1/\(pathVariable0)"
        }()
        var query = [
      ...
      public func listCachedContents(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.ListCachedContentsResponse.self, from: data)
      }
