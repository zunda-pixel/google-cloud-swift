...
// limitations under the License.
  ...
  extension Clients {
    ...
    class FeatureOnlineStoreServiceTransport: FeatureOnlineStoreServiceStub {
      ...
      public func fetchFeatureValues(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0):fetchFeatureValues"
        }()
        let query = [
        ...
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.FetchFeatureValuesResponse.self, from: data)
      }
      ...
      public func searchNearestEntities(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0):searchNearestEntities"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.SearchNearestEntitiesResponse.self, from: data)
      }
      ...
      public func featureViewDirectWrite(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0):directWrite"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.FeatureViewDirectWriteResponse.self, from: data)
      }
      ...
      public func generateFetchAccessToken(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0):generateFetchAccessToken"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.GenerateFetchAccessTokenResponse.self, from: data)
      }
