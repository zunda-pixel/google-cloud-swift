...
// limitations under the License.
  ...
  extension Clients {
    final class FeatureRegistryServiceRetry: FeatureRegistryServiceStub {
      let inner: any FeatureRegistryServiceStub
      let options: GoogleCloudGax.ClientOptions

      public init(_ inner: any FeatureRegistryServiceStub, options: GoogleCloudGax.ClientOptions) {
        self.inner = inner
