...
// limitations under the License.
  ...
  extension Clients {
    ...
    class PersistentResourceServiceTransport: PersistentResourceServiceStub {
      ...
      public func createPersistentResource(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0)/persistentResources"
        }()
        var query = [
        ...
        query.append(
          contentsOf: try encoder.encode(
            request.persistentResourceId, prefix: "persistentResourceId"))
      ...
      public func getPersistentResource(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.PersistentResource.self, from: data)
      }
      ...
      public func listPersistentResources(
        ...
        let (data, _) = try await self.inner.rpc(for: req).get()
        return try GoogleCloudWkt._ProtoJSONDecoder().decode(
          GoogleCloudAiplatformV1.ListPersistentResourcesResponse.self, from: data)
      }
      ...
      public func updatePersistentResource(
        ...
        let path = try { () throws -> Swift.String in
          guard let pathVariable0 = request.persistentResource.map({ $0.name }),
            !pathVariable0.isEmpty
          else {
            throw GoogleCloudGax.RequestError.binding(
              "'request.persistent_resource.name' is not set or is empty")
          }
          return "/v1/\(pathVariable0)"
        }()
        var query = [
      ...
      public func rebootPersistentResource(
        ...
        let path = try { () throws -> Swift.String in
          ...
          return "/v1/\(pathVariable0):reboot"
        }()
        let query = [
          URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
        ]
