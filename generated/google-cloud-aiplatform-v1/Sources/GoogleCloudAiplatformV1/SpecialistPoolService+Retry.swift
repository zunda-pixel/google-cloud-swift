...
// limitations under the License.
  ...
  extension Clients {
    final class SpecialistPoolServiceRetry: SpecialistPoolServiceStub {
      let inner: any SpecialistPoolServiceStub
      let options: GoogleCloudGax.ClientOptions

      public init(_ inner: any SpecialistPoolServiceStub, options: GoogleCloudGax.ClientOptions) {
        self.inner = inner
      ...
      public func createSpecialistPool(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: CreateSpecialistPoolRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleLongrunning.Operation
            in
            return try await self.inner.createSpecialistPool(request: r, options: o)
          })
      }
      ...
      public func getSpecialistPool(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: GetSpecialistPoolRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleCloudAiplatformV1.SpecialistPool
            in
            return try await self.inner.getSpecialistPool(request: r, options: o)
          })
      }
      ...
      public func listSpecialistPools(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: ListSpecialistPoolsRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleCloudAiplatformV1.ListSpecialistPoolsResponse
            in
            return try await self.inner.listSpecialistPools(request: r, options: o)
          })
      }
      ...
      public func deleteSpecialistPool(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: DeleteSpecialistPoolRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleLongrunning.Operation
            in
            return try await self.inner.deleteSpecialistPool(request: r, options: o)
          })
      }
      ...
      public func updateSpecialistPool(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: UpdateSpecialistPoolRequest, o: GoogleCloudGax.RequestOptions) async throws
              -> GoogleLongrunning.Operation
            in
            return try await self.inner.updateSpecialistPool(request: r, options: o)
          })
      }
