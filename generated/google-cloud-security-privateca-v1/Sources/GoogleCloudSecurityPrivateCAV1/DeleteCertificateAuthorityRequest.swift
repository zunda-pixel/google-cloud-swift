...
///
/// [google.cloud.security.privateca.v1.CertificateAuthorityService.DeleteCertificateAuthority]: <doc:CertificateAuthorityService/deleteCertificateAuthority(request:)>
public struct DeleteCertificateAuthorityRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  public var ignoreActiveCertificates: Swift.Bool = Swift.Bool()

  /// Optional. If this flag is set, the Certificate Authority will be deleted as
  /// soon as possible without a 30-day grace period where undeletion would have
  /// been allowed. If you proceed, there will be no way to recover this CA.
  public var skipGracePeriod: Swift.Bool = Swift.Bool()
  ...
  /// Initialize a new instance of `DeleteCertificateAuthorityRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteCertificateAuthorityRequest().with { $0.name = ... }
  /// ```
