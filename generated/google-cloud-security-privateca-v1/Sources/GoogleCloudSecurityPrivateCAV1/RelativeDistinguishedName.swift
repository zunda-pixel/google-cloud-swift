  ...
  Sendable
{
  ...
  public var attributes: [AttributeTypeAndValue] = []

  /// Initialize a new instance of `RelativeDistinguishedName`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = RelativeDistinguishedName().with { $0.attributes = ... }
  /// ```
