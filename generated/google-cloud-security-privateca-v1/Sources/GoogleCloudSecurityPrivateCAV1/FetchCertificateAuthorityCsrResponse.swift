...
public struct FetchCertificateAuthorityCsrResponse: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  /// Output only. The PEM-encoded signed certificate signing request (CSR).
  public var pemCsr: Swift.String = Swift.String()

  /// Initialize a new instance of `FetchCertificateAuthorityCsrResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = FetchCertificateAuthorityCsrResponse().with { $0.pemCsr = ... }
  /// ```
