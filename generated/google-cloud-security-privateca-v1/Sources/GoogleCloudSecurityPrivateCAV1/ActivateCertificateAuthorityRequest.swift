...
public struct ActivateCertificateAuthorityRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  ///
  /// [google.cloud.security.privateca.v1.FetchCertificateAuthorityCsrResponse.pem_csr]: <doc:FetchCertificateAuthorityCsrResponse/pemCsr>
  public var pemCaCertificate: Swift.String = Swift.String()
  ...
  /// Initialize a new instance of `ActivateCertificateAuthorityRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ActivateCertificateAuthorityRequest().with { $0.name = ... }
  /// ```
