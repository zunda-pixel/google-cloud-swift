  ...
  Sendable
{
  ...
  public var certificateTemplateId: Swift.String = Swift.String()
  ...
  /// Initialize a new instance of `CreateCertificateTemplateRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = CreateCertificateTemplateRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.security.privateca.v1.CreateCertificateTemplateRequest"
  }
