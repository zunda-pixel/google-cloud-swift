...
public struct FetchCertificateAuthorityCsrRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `FetchCertificateAuthorityCsrRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = FetchCertificateAuthorityCsrRequest().with { $0.name = ... }
  /// ```
