...
public struct ExecuteSingleTenantHsmInstanceProposalRequest: Codable, Equatable, GoogleCloudWkt
    ._AnyPackable,
  Sendable
{
  /// Required. The
  ...
  /// Initialize a new instance of `ExecuteSingleTenantHsmInstanceProposalRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ExecuteSingleTenantHsmInstanceProposalRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.kms.v1.ExecuteSingleTenantHsmInstanceProposalRequest"
  }
