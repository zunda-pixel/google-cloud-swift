...
///
/// [google.cloud.kms.v1.KeyManagementService.GetRetiredResource]: <doc:KeyManagementService/getRetiredResource(request:)>
  ...
  Sendable
{
  ...
  /// [google.cloud.kms.v1.RetiredResource.name]: <doc:RetiredResource/name>
  public var name: Swift.String = Swift.String()

  /// Initialize a new instance of `GetRetiredResourceRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetRetiredResourceRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.kms.v1.GetRetiredResourceRequest"
  }
