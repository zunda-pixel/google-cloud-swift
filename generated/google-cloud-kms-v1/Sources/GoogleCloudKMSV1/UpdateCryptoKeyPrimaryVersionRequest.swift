...
public struct UpdateCryptoKeyPrimaryVersionRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  public var cryptoKeyVersionId: Swift.String = Swift.String()

  /// Initialize a new instance of `UpdateCryptoKeyPrimaryVersionRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateCryptoKeyPrimaryVersionRequest().with { $0.name = ... }
  /// ```
