  ...
  Sendable
{
  ...
  /// Initialize a new instance of `VerifyConnectivityRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = VerifyConnectivityRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.kms.v1.VerifyConnectivityRequest"
  }
