  ...
  Sendable
{
  ...
  /// Initialize a new instance of `DeleteCryptoKeyVersionRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DeleteCryptoKeyVersionRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.kms.v1.DeleteCryptoKeyVersionRequest"
  }
