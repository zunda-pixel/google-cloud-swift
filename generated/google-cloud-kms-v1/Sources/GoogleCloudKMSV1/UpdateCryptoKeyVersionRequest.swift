...
///
/// [google.cloud.kms.v1.KeyManagementService.UpdateCryptoKeyVersion]: <doc:KeyManagementService/updateCryptoKeyVersion(request:)>
  ...
  Sendable
{
  ...
  ///
  /// ```
  /// let value = UpdateCryptoKeyVersionRequest().with { $0.cryptoKeyVersion = ... }
  /// ```
