...
public struct ExportTrustedKeyWrappedCryptoKeyVersionRequest: Codable, Equatable, GoogleCloudWkt
    ._AnyPackable,
  Sendable
{
  ...
  /// [google.cloud.kms.v1.CryptoKeyVersion.trusted_wrapping_enabled]: <doc:CryptoKeyVersion/trustedWrappingEnabled>
  ...
  ///
  /// [google.cloud.kms.v1.CryptoKeyVersion]: <doc:CryptoKeyVersion>
  /// [google.cloud.kms.v1.CryptoKeyVersion.hsm_trusted]: <doc:CryptoKeyVersion/hsmTrusted>
  /// [google.cloud.kms.v1.CryptoKeyVersion.name]: <doc:CryptoKeyVersion/name>
  ...
  ///
  /// ```
  /// let value = ExportTrustedKeyWrappedCryptoKeyVersionRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.kms.v1.ExportTrustedKeyWrappedCryptoKeyVersionRequest"
  }
