...
///
/// [google.cloud.kms.v1.KeyManagementService.UpdateCryptoKey]: <doc:KeyManagementService/updateCryptoKey(request:)>
  ...
  Sendable
{
  ...
  ///
  /// ```
  /// let value = UpdateCryptoKeyRequest().with { $0.cryptoKey = ... }
  /// ```
