...
///
/// [google.cloud.kms.v1.EkmService.UpdateEkmConnection]: <doc:EkmService/updateEkmConnection(request:)>
  ...
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateEkmConnectionRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateEkmConnectionRequest().with { $0.ekmConnection = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.kms.v1.UpdateEkmConnectionRequest"
  }
