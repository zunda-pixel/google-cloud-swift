  ...
  Sendable
{
  ...
  public var protectedResources: [ProtectedResource] = []

  /// A token that can be sent as `page_token` to retrieve the next page.
  /// If this field is omitted, there are no subsequent pages.
  public var nextPageToken: Swift.String = Swift.String()

  /// Initialize a new instance of `SearchProtectedResourcesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SearchProtectedResourcesResponse().with { $0.protectedResources = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.kms.inventory.v1.SearchProtectedResourcesResponse"
  }
