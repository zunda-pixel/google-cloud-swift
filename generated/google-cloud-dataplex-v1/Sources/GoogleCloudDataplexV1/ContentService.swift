...
public class ContentServiceClient: Clients.ContentServiceProtocol {
  ...
  public init(_ options: GoogleCloudGax.ClientOptions = .init()) throws {
    var inner: any Clients.ContentServiceStub = try Clients.ContentServiceTransport(options)
    inner = Clients.ContentServiceRetry(inner, options: options)
    if let logger = options.logger {
      inner = Clients.ContentServiceLogging(inner, logger: logger)
    }
    self.inner = inner
  }
  ...
  ///
  /// @Snippet(path: "ContentService_GetLocation")
  ...
  /// errors.
  ///
  /// @Snippet(path: "ContentService_SetIamPolicy")
  ...
  ///
  /// @Snippet(path: "ContentService_GetIamPolicy")
  ...
  ///
  /// @Snippet(path: "ContentService_TestIamPermissions")
  ...
  /// [google.longrunning.Operations]: https://www.google.com/search?q=Swift+google.longrunning+Operations
  ///
  /// @Snippet(path: "ContentService_GetOperation")
  func getOperation(
  ...
  /// [google.longrunning.Operations]: https://www.google.com/search?q=Swift+google.longrunning+Operations
  ///
  /// @Snippet(path: "ContentService_DeleteOperation")
  ...
  /// [google.longrunning.Operations]: https://www.google.com/search?q=Swift+google.longrunning+Operations
  ///
  /// @Snippet(path: "ContentService_CancelOperation")
...
extension Clients {
  /// A Swift protocol to mock `ContentServiceClient`.
  ///
  /// To mock `ContentServiceClient` change your functions to receive
  /// `some ContentServiceProtocol` or `any ContentServiceProtocol`
  /// and pass a mock implementation in your tests.
  public protocol ContentServiceProtocol {
    /// See `ContentServiceClient.listLocations`.
    ...
    /// See `ContentServiceClient.getLocation`.
    func getLocation(request: GoogleCloudLocation.GetLocationRequest) async throws
      -> GoogleCloudLocation.Location

    /// See `ContentServiceClient.setIamPolicy`.
    func setIamPolicy(request: GoogleIAMV1.SetIamPolicyRequest) async throws -> GoogleIAMV1.Policy

    /// See `ContentServiceClient.getIamPolicy`.
    func getIamPolicy(request: GoogleIAMV1.GetIamPolicyRequest) async throws -> GoogleIAMV1.Policy

    /// See `ContentServiceClient.testIamPermissions`.
    func testIamPermissions(request: GoogleIAMV1.TestIamPermissionsRequest) async throws
      -> GoogleIAMV1.TestIamPermissionsResponse

    /// See `ContentServiceClient.listOperations`.
    ...
    /// See `ContentServiceClient.deleteOperation`.
    ...
    /// See `ContentServiceClient.cancelOperation`.
...
extension Clients.ContentServiceProtocol {
