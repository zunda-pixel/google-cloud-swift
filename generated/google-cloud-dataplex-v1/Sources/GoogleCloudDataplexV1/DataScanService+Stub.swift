...
extension Clients {
  ...
  class DataScanServiceTransport: DataScanServiceStub {
    ...
    public func getDataScan(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudDataplexV1.DataScan.self, from: data)
    }
    ...
    public func listDataScans(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudDataplexV1.ListDataScansResponse.self, from: data)
    }
    ...
    public func runDataScan(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudDataplexV1.RunDataScanResponse.self, from: data)
    }
    ...
    public func getDataScanJob(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudDataplexV1.DataScanJob.self, from: data)
    }
    ...
    public func listDataScanJobs(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudDataplexV1.ListDataScanJobsResponse.self, from: data)
    }
    ...
    public func cancelDataScanJob(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudDataplexV1.CancelDataScanJobResponse.self, from: data)
    }
    ...
    public func generateDataQualityRules(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudDataplexV1.GenerateDataQualityRulesResponse.self, from: data)
    }
