...
extension Clients {
  final class DataScanServiceRetry: DataScanServiceStub {
    ...
    public init(_ inner: any DataScanServiceStub, options: GoogleCloudGax.ClientOptions) {
      self.inner = inner
    ...
    public func createDataScan(
      ...
      try await self._intercept(
        ...
        idempotent: false,
        action: {
          (r: CreateDataScanRequest, o: GoogleCloudGax.RequestOptions) async throws
    ...
    public func updateDataScan(
      ...
      try await self._intercept(
        ...
        idempotent: false,
        action: {
          (r: UpdateDataScanRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleLongrunning.Operation
          in
    ...
    public func deleteDataScan(
      ...
      try await self._intercept(
        ...
        idempotent: false,
        action: {
          (r: DeleteDataScanRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleLongrunning.Operation
          in
    ...
    public func getDataScan(
      ...
      try await self._intercept(
        ...
        idempotent: true,
        action: {
          (r: GetDataScanRequest, o: GoogleCloudGax.RequestOptions) async throws
    ...
    public func listDataScans(
      ...
      try await self._intercept(
        ...
        idempotent: true,
        action: {
          (r: ListDataScansRequest, o: GoogleCloudGax.RequestOptions) async throws
    ...
    public func runDataScan(
      ...
      try await self._intercept(
        ...
        idempotent: false,
        action: {
          (r: RunDataScanRequest, o: GoogleCloudGax.RequestOptions) async throws
    ...
    public func getDataScanJob(
      ...
      try await self._intercept(
        ...
        idempotent: true,
        action: {
          (r: GetDataScanJobRequest, o: GoogleCloudGax.RequestOptions) async throws
    ...
    public func listDataScanJobs(
      ...
      try await self._intercept(
        ...
        idempotent: true,
        action: {
          (r: ListDataScanJobsRequest, o: GoogleCloudGax.RequestOptions) async throws
    ...
    public func cancelDataScanJob(
      ...
      try await self._intercept(
        ...
        idempotent: false,
        action: {
          (r: CancelDataScanJobRequest, o: GoogleCloudGax.RequestOptions) async throws
    ...
    public func generateDataQualityRules(
      ...
      try await self._intercept(
        ...
        idempotent: false,
        action: {
          (r: GenerateDataQualityRulesRequest, o: GoogleCloudGax.RequestOptions) async throws
