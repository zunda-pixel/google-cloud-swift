...
extension Clients {
  final class ContentServiceRetry: ContentServiceStub {
    let inner: any ContentServiceStub
    let options: GoogleCloudGax.ClientOptions

    public init(_ inner: any ContentServiceStub, options: GoogleCloudGax.ClientOptions) {
      self.inner = inner
