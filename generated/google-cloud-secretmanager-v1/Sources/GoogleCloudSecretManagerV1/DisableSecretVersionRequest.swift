  ...
  Sendable
{
  ...
  /// Initialize a new instance of `DisableSecretVersionRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = DisableSecretVersionRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.secretmanager.v1.DisableSecretVersionRequest"
  }
