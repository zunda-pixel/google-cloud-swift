...
extension Clients {
  ...
  class AppGatewaysServiceTransport: AppGatewaysServiceStub {
    ...
    public func listAppGateways(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/appGateways"
      }()
      var query = [
    ...
    public func createAppGateway(
      ...
      let encoder = GoogleCloudGax.QueryParameterEncoder()
      query.append(contentsOf: try encoder.encode(request.appGatewayId, prefix: "appGatewayId"))
