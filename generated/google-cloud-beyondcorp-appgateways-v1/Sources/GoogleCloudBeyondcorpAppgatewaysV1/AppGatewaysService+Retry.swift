...
extension Clients {
  final class AppGatewaysServiceRetry: AppGatewaysServiceStub {
    let inner: any AppGatewaysServiceStub
    let options: GoogleCloudGax.ClientOptions

    public init(_ inner: any AppGatewaysServiceStub, options: GoogleCloudGax.ClientOptions) {
      self.inner = inner
    ...
    public func listAppGateways(
      ...
      try await self._intercept(
        ...
        idempotent: true,
        action: {
          (r: ListAppGatewaysRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleCloudBeyondcorpAppgatewaysV1.ListAppGatewaysResponse
          in
          return try await self.inner.listAppGateways(request: r, options: o)
        })
    }
    ...
    public func getAppGateway(
      ...
      try await self._intercept(
        ...
        idempotent: true,
        action: {
          (r: GetAppGatewayRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleCloudBeyondcorpAppgatewaysV1.AppGateway
          in
          return try await self.inner.getAppGateway(request: r, options: o)
        })
    }
    ...
    public func createAppGateway(
      ...
      try await self._intercept(
        ...
        idempotent: false,
        action: {
          (r: CreateAppGatewayRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleLongrunning.Operation
          in
          return try await self.inner.createAppGateway(request: r, options: o)
        })
    }
    ...
    public func deleteAppGateway(
      ...
      try await self._intercept(
        ...
        idempotent: false,
        action: {
          (r: DeleteAppGatewayRequest, o: GoogleCloudGax.RequestOptions) async throws
            -> GoogleLongrunning.Operation
          in
          return try await self.inner.deleteAppGateway(request: r, options: o)
        })
    }
