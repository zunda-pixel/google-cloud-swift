...
/// the organization.
public struct GetOrganizationIntelligenceConfigRequest: Codable, Equatable, GoogleCloudWkt
    ._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetOrganizationIntelligenceConfigRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetOrganizationIntelligenceConfigRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.storage.control.v2.GetOrganizationIntelligenceConfigRequest"
  }
