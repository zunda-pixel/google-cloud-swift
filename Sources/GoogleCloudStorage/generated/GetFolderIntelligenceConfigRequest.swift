  ...
  Sendable
{
  ...
  /// Initialize a new instance of `GetFolderIntelligenceConfigRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetFolderIntelligenceConfigRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.storage.control.v2.GetFolderIntelligenceConfigRequest"
  }
