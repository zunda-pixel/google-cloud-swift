...
public enum FindingCategory: Codable, Equatable, Sendable {
  ...
  public var stringValue: Swift.String? {
    ...
    case .performance: return "FINDING_CATEGORY_PERFORMANCE"
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownStringValue`](doc:FindingCategory/unknownStringValue(_:)).
  public init(stringValue: Swift.String) {
    switch stringValue {
    case "FINDING_CATEGORY_UNSPECIFIED": self = .unspecified
    case "FINDING_CATEGORY_DATA_MANAGEMENT": self = .dataManagement
    case "FINDING_CATEGORY_PERFORMANCE": self = .performance
  ...
  ///
  /// If the value is unknown, this initializes to [`unknownIntValue`](doc:FindingCategory/unknownIntValue(_:)).
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    case .dataManagement: return try container.encode(1)
