...
/// on the project.
public struct GetProjectIntelligenceConfigRequest: Codable, Equatable, GoogleCloudWkt._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `GetProjectIntelligenceConfigRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = GetProjectIntelligenceConfigRequest().with { $0.name = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.storage.control.v2.GetProjectIntelligenceConfigRequest"
  }
