...
/// the organization.
public struct UpdateOrganizationIntelligenceConfigRequest: Codable, Equatable, GoogleCloudWkt
    ._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `UpdateOrganizationIntelligenceConfigRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = UpdateOrganizationIntelligenceConfigRequest().with { $0.intelligenceConfig = ... }
  /// ```
