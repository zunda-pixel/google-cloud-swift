...
/// with a project.
public struct ListIntelligenceFindingRevisionsRequest: Codable, Equatable, GoogleCloudWkt
    ._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListIntelligenceFindingRevisionsRequest`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListIntelligenceFindingRevisionsRequest().with { $0.parent = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.storage.control.v2.ListIntelligenceFindingRevisionsRequest"
  }
