...
/// with a project.
public struct ListIntelligenceFindingRevisionsResponse: Codable, Equatable, GoogleCloudWkt
    ._AnyPackable,
  GoogleCloudGax._PaginatedResponse,
  Sendable
{
  /// The `IntelligenceFindingRevision` resources from the specified project.
  public var intelligenceFindingRevisions: [IntelligenceFindingRevision] = []

  /// A token that can be sent as `page_token` to retrieve the next page.
  public var nextPageToken: Swift.String = Swift.String()

  /// Initialize a new instance of `ListIntelligenceFindingRevisionsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListIntelligenceFindingRevisionsResponse().with { $0.intelligenceFindingRevisions = ... }
  /// ```
